## Computes the EOFs and PCs of vertical velocity from gSAM DYAMOND Winter data
## Updated: 8/3/2024
...
def main():
    ...
    data = data.assign_coords({'time': pd.date_range('20200201', '20200229 21:00:00', freq='3h')})
